...
import { BotSettings, defaultNumCtx, chatBot } from './utils';
import { loadModelDirectories, ModelDirectories } from './api-connections/library-refresh';
import { initializeCache, getState, restoreMessageDataFromCache, messageDataMap } from './managers/cache-manager';
...
import { handleMessageCreate } from './message-generation/message-create';
...
async function loadModelDirectoriesAndRegisterCommands() {
  // Load model directories and register commands
  modelDirectories = await loadModelDirectories();
