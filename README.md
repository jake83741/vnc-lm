...
vnc-lm is a Discord bot for loading and configuring language models. Configure model parameters, branch conversations, and edit prompts to improve responses. It is integrated with the [**ollama**](https://github.com/ollama/ollama) and [**LiteLLM**](https://www.litellm.ai/), which enables communication with most LLM APIs, see the full list below.
