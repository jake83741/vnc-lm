...
Load and configure language models through [**ollama**](https://github.com/ollama/ollama) or through several popular hosted and local APIs with [**LiteLLM**](https://www.litellm.ai/). Configure model parameters, branch conversations, and edit prompts to improve responses.
